...
#    assert (
#        db.session.query(EditorsBooks)
#        .filter_by(editor_id=editor_id, book_id=book_id)
#        .first()
#    ) is None
#    assert (
#        db.session.query(EditorsManuscripts)
#        .filter_by(editor_id=editor_id, manuscript_id=manuscript_id)
#        .first()
#    ) is None
...
# def test_delete_editor_manuscript_by_id_endpoint(db_w_cleanup, staged_app_client): # 43/83
#    db = db_w_cleanup
#    app, client = staged_app_client
#
#    editor_obj = Genius.gen_editor_obj()
#    manuscript_obj = Genius.gen_manuscript_obj()
#    manuscript_id = manuscript_obj.manuscript_id
#    Genius.gen_editors_manuscripts_obj(editor_obj.editor_id, manuscript_id)
#
...
#    assert (
#        db.session.query(EditorsManuscripts)
#        .filter_by(editor_id=editor_obj.editor_id, manuscript_id=manuscript_id)
#        .first()
#        is None
#    )
#
...
#    bogus_editor_id = random.randint(1, 10)
#    bogus_book_id = random.randint(1, 10)
#    response = client.get(f"/editors/{bogus_editor_id}/books/{bogus_book_id}")
